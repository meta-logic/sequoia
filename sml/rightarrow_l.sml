...
fun rightarrow_l ((Single ((Form (A, Con ("\\rightarrow"), B))::Gamma), Con ("\\vdash"), Single (C::nil))) = [(Single (Gamma), Con ("\\vdash"), Single (A::nil)),(Single (B::Gamma), Con ("\\vdash"), Single (C::nil))]
	| rightarrow_l _ = []
