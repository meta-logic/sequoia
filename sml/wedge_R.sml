...
fun wedge_R (Single ((Form (Atom (A), Con ("\\wedge"), (Form (Atom (B), Con ("\\rightarrow"), Atom (C)))))::nil)) = [Single ((Form (Atom (A), Con ("\\rightarrow"), Atom (C)))::nil),Single ((Form (Atom (B), Con ("\\rightarrow"), Atom (C)))::nil)]
	| wedge_R _ = []
