...
fun wedge_R ((Single ((Form (Atom (A), Con ("\\wedge"), Atom (B)))::Gamma), Con ("\\rightarrow"), Single (Atom (C)::nil))) = [(Single (Atom (A)::Gamma), Con ("\\rightarrow"), Single (Atom (C)::nil)),(Single (Atom (B)::Gamma), Con ("\\rightarrow"), Single (Atom (C)::nil))]
	| wedge_R _ = []
