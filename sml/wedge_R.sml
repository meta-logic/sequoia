...
fun wedge_R ((Single (Gamma), Con ("\\vdash"), Single ((Form (Form (A), Con ("\\wedge"), Form (B)))::Delta))) = [(Single (Gamma), Con ("\\vdash"), Single (Form (A)::Delta)),(Single (Gamma), Con ("\\vdash"), Single (Form (B)::Delta))]
	| wedge_R _ = []
