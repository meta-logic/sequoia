...
struct
	...
	val test1 = E.check_consistent (constraints,t1_vars,t2_vars)
	...
	val test2 = E.check_consistent (constraints2,t1_vars2,t2_vars2)
	...
	val test3 = E.check_consistent (constraints3,t1_vars,t2_vars)
	...
	val test4 = E.check_consistent (constraints4,t_left_vars,t_right_vars)
	val test5 = E.check_consistent (constraints4,t_right_vars,t_left_vars)
