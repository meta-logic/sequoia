...
function writeRule(rule, conclusion, premises, args, toString) {
    ...
    var file = ""
    if (args.length == 0) {
        file = datatypes + "fun " + rule + " (" + conclusion + ") = [" + premises.join() + "]\n\t| " + rule +" _ = []\n"
    } else {
        file = datatypes + "fun " + rule + " (" + conclusion + "," + args.join(",") + ") = [" + premises.join() + "]\n\t| " + rule +" _ = []\n"
    }
