...
fun cut ((Single (Gamma_2::Gamma_1), Con ("\\rightarrow"), Single (Atom (C)::nil)),A) = [(Single (Gamma_1), Con ("\\rightarrow"), Single (Atom (A)::nil)),(Single (Atom (A)::Gamma_2), Con ("\\rightarrow"), Single (Atom (C)::nil))]
	| cut _ = []
