...
struct
	...
	structure E = Equivalence(Dat)
	
	val t1_vars = [Dat.CtxVar(""),Dat.CtxVar("1"),Dat.CtxVar("2"),Dat.CtxVar("3"),Dat.CtxVar("4")]
	val t2_vars = [Dat.CtxVar("p"),Dat.CtxVar("p1"),Dat.CtxVar("p2"),Dat.CtxVar("p3"),Dat.CtxVar("p4")]
	val constraints = [(Dat.CtxVar("test"),[Dat.CtxVar("")],[Dat.CtxVar("1"),Dat.CtxVar("2")]),
	...
	val goal = [(Dat.CtxVar("test"),[Dat.CtxVar("")],[Dat.CtxVar("p")])]
	...
	val t1_vars2 = [Dat.CtxVar(""),Dat.CtxVar("1"),Dat.CtxVar("2")]
	val t2_vars2 = [Dat.CtxVar("p")]
	val constraints2 = [(Dat.CtxVar("test"),[Dat.CtxVar("")],[Dat.CtxVar("1"),Dat.CtxVar("2")]),
	...
	val constraints3 = [(Dat.CtxVar("test"),[Dat.CtxVar("")],[Dat.CtxVar("1"),Dat.CtxVar("2")]),
					   (Dat.CtxVar("test"),[Dat.CtxVar("2")],[Dat.CtxVar("3"),Dat.CtxVar("4")]),
					   (Dat.CtxVar("test"),[Dat.CtxVar("p")],[Dat.CtxVar("p1"),Dat.CtxVar("p2")]),
					   (Dat.CtxVar("test"),[Dat.CtxVar("p1")],[Dat.CtxVar("p3"),Dat.CtxVar("p4")]),
					   (Dat.CtxVar("test"),[Dat.CtxVar("1")],[Dat.CtxVar("p3")]),
					   (Dat.CtxVar("test"),[Dat.CtxVar("3")],[Dat.CtxVar("p4")]),
					   (Dat.CtxVar("test"),[Dat.CtxVar("4")],[Dat.CtxVar("p2")]),
					   (Dat.CtxVar("test"),[Dat.CtxVar("")],[Dat.CtxVar("p3")])]
